      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-[#1a2537] rounded-lg overflow-hidden">
              <div className="h-64 bg-[#2a3547]"></div>
              <div className="p-4">
                <h3 className="font-medium text-white mb-1">Book Title</h3>
                <p className="text-sm text-gray-400 mb-3">Author Name</p>
                  ...
                  <div className="flex items-center">
                    <div className="flex text-yellow-400">
                      {[...Array(5)].map((_, i) => (
                        <svg
                          key={i}
                          className={`w-4 h-4 ${i < 4 ? 'text-yellow-400' : 'text-[#2a3547]'}`}
                          fill="currentColor"
                          viewBox="0 0 20 20"
                        >
